...
#SBATCH -e ./log/nc_80g.err
#SBATCH -o ./log/nc_80g.out
#SBATCH --time=12:00:00             # limit of wall clock time - how long the job will run (same as -t)
#SBATCH --exclude=nif-[000-005]                # exclude 40g a100
...
#SBATCH --job-name nc_80g # you can give your job a name for easier identification (same as -J)
