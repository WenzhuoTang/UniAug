...
#SBATCH -e ./log/graph_pred_collab.err
#SBATCH -o ./log/graph_pred_collab.out
...
#SBATCH --job-name gp_collab # you can give your job a name for easier identification (same as -J)
