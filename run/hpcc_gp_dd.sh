...
#SBATCH -e ./log/graph_pred_dd.err
#SBATCH -o ./log/graph_pred_dd.out
...
#SBATCH --job-name gp_dd # you can give your job a name for easier identification (same as -J)
...
launch () {
    ...
    ## guidance
    # extra_args+="--prefix step_size-1.0 "
    # extra_config+="augment.sample.step_size=1.0 "
