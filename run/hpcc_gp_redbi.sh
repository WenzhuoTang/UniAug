...
#SBATCH -e ./log/graph_pred_reddit_binary.err
...
#SBATCH --job-name gp_redbi # you can give your job a name for easier identification (same as -J)
...
### full_nr_gnn_gt_l4_dnnm-0_deg_lin_self_guid
